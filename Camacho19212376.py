...
plt.plot(t,Vsu1,'--',color=clr2,label='Vs(t)') #Respuesta en lazo abierto
...
plt.plot(t,Vsu2,'--',color=clr2,label='Vs(t)') #Respuesta en lazo abierto
...
plt.plot(t,Vsu3,'--',color=clr2,label='Vs(t)') #Respuesta en lazo abierto
...
plt.plot(t,Vsu4,'--',color=clr2,label='Vs(t)') #Respuesta en lazo abierto
